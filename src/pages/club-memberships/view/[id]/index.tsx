...
import { getClubMembershipById } from 'apiSdk/club-memberships';
...
function ClubMembershipViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('club_membership', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/club-memberships/edit/${data?.id}`} passHref legacyBehavior>
              <Button
